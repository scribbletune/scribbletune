...
module.exports = params => {
	...
	if (params.player) {
		...
		return new Tone.Sequence(getSeqFn(params.player), utils.expandStr(params.pattern), params.subdiv || defaultSubdiv);
	}
	...
	if (params.instrument) {
		...
		return new Tone.Sequence(getInstrSeqFn(params), utils.expandStr(params.pattern), params.subdiv || defaultSubdiv);
	}
};
